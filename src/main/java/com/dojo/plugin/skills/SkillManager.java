...
public class SkillManager {
    ...
    private void damageAndStun(Player source, LivingEntity target, WeaponSkill skill) {
        ...
        target.addPotionEffect(new PotionEffect(PotionEffectType.SLOWNESS, skill.getStunTicks(), 250, false, true));
        target.addPotionEffect(new PotionEffect(PotionEffectType.JUMP, skill.getStunTicks(), 128, false, true));
    }
